-- CORRECCIÓN DE PERMISOS PARA LÍDERES Y EVENTOS
-- Ejecuta este script completo en el Editor SQL de Supabase

-- 1. TABLA LÍDERES (social_lideres)
ALTER TABLE social_lideres ENABLE ROW LEVEL SECURITY;

-- Eliminar políticas anteriores para evitar errores de duplicados
...
-- Crear políticas permisivas (Permite crear, ver, editar y borrar a todos)
...
-- 2. TABLA EVENTOS (social_eventos) - Por si acaso
...
-- 3. TABLA BOLETAS (social_boletas) - Por si acaso

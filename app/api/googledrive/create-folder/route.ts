...
import { crearCarpetaRevisionDrive } from '@/lib/googledrive';

/**
 * API Route: Crea la estructura de carpetas en Google Drive para una revisión
 * POST /api/googledrive/create-folder
...
export async function POST(request: NextRequest) {
  try {
    ...
    const resultado = await crearCarpetaRevisionDrive(
      accessToken,
      revisionId,
      fechaRevision
    );

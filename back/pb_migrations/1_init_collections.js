...
migrate((app) => {
  ...
  const revisiones = new Collection({
    ...
    fields: [
      ...
      { name: "estado", type: "select", values: ["abierta", "en_seguimiento", "cerrada"], maxSelect: 1, required: true },
      // Entradas 9.3.2
  ...
  const compromisos = new Collection({
    ...
    type: "base",
    fields: [
      { name: "revision_id", type: "relation", collectionId: revisiones.id, maxSelect: 1, cascadeDelete: false },
      { name: "codigo_compromiso", type: "text" },
      { name: "tipo_salida", type: "select", values: ["mejora", "cambio_sgc", "recursos"], maxSelect: 1, required: true },
      ...
      { name: "estado", type: "select", values: ["pendiente", "en_proceso", "completado", "vencido", "cancelado"], maxSelect: 1, required: true },
      { name: "prioridad", type: "select", values: ["alta", "media", "baja"], maxSelect: 1, required: true },
  ...
  const auditorias = new Collection({
    ...
    fields: [
      ...
      { name: "tipo", type: "select", values: ["interna", "externa", "certificacion"], maxSelect: 1, required: true },
      ...
      { name: "estado_general", type: "select", values: ["satisfactorio", "requiere_mejoras", "critico"], maxSelect: 1 },
  ...
  const quejas_reclamos = new Collection({
    ...
    fields: [
      ...
      { name: "tipo", type: "select", values: ["queja", "reclamo", "sugerencia", "felicitacion"], maxSelect: 1, required: true },
      { name: "cliente", type: "text", required: true },
      { name: "producto_servicio", type: "text" },
      { name: "descripcion", type: "text", required: true },
      { name: "estado", type: "select", values: ["abierta", "en_analisis", "resuelta", "cerrada"], maxSelect: 1, required: true },
  ...
  const indicadores = new Collection({
    ...
    fields: [
      ...
      { name: "tendencia", type: "select", values: ["mejora", "estable", "deterioro"], maxSelect: 1 },
  ...
  const no_conformidades = new Collection({
    ...
    fields: [
      ...
      { name: "tipo", type: "select", values: ["producto", "proceso", "sistema"], maxSelect: 1, required: true },
      { name: "severidad", type: "select", values: ["mayor", "menor", "critica"], maxSelect: 1 },
      ...
      { name: "estado", type: "select", values: ["abierta", "en_analisis", "en_implementacion", "cerrada"], maxSelect: 1, required: true },
  ...
  const proveedores = new Collection({
    ...
    fields: [
      ...
      { name: "estado", type: "select", values: ["aprobado", "condicional", "no_aprobado"], maxSelect: 1 },
  ...
  const objetivos_calidad = new Collection({
    ...
    fields: [
      ...
      { name: "estado", type: "select", values: ["activo", "completado", "cancelado", "retrasado"], maxSelect: 1, required: true },
  ...
  const gestion_cambios = new Collection({
    ...
    fields: [
      ...
      { name: "tipo", type: "select", values: ["externo", "interno"], maxSelect: 1, required: true },
      { name: "categoria", type: "select", values: ["economico", "legal", "tecnologico", "competitivo", "social", "organizacional", "operacional"], maxSelect: 1 },
      { name: "descripcion", type: "text", required: true },
      { name: "impacto_sgc", type: "select", values: ["alto", "medio", "bajo"], maxSelect: 1 },
      { name: "oportunidad_amenaza", type: "select", values: ["oportunidad", "amenaza", "neutral"], maxSelect: 1 },
      { name: "partes_interesadas_afectadas", type: "json" },
      { name: "procesos_impactados", type: "json" },
      { name: "acciones_tomadas", type: "text" },
      { name: "responsable", type: "text" },
      { name: "estado", type: "select", values: ["activo", "mitigado", "cerrado"], maxSelect: 1, required: true },
    ],
  })
  ...
  const inspecciones_verificacion = new Collection({
    ...
    fields: [
      ...
      { name: "tipo_inspeccion", type: "select", values: ["producto", "proceso", "instalacion", "equipo"], maxSelect: 1, required: true },
      { name: "area_proceso", type: "text" },
      { name: "inspector", type: "text", required: true },
      { name: "criterios_verificacion", type: "text" },
      { name: "resultado", type: "select", values: ["conforme", "no_conforme", "con_observaciones"], maxSelect: 1 },
  ...
  const riesgos_oportunidades = new Collection({
    ...
    fields: [
      ...
      { name: "tipo", type: "select", values: ["riesgo", "oportunidad"], maxSelect: 1, required: true },
      { name: "categoria", type: "select", values: ["operacional", "estrategico", "financiero", "cumplimiento", "reputacional"], maxSelect: 1 },
      { name: "descripcion", type: "text", required: true },
      ...
      { name: "estado", type: "select", values: ["identificado", "en_tratamiento", "mitigado", "cerrado"], maxSelect: 1, required: true },
  ...
  const oportunidades_mejora = new Collection({
    ...
    fields: [
      ...
      { name: "descripcion", type: "text", required: true },
      { name: "area_proceso", type: "text" },
      { name: "tipo_mejora", type: "select", values: ["correctiva", "preventiva", "innovacion", "optimizacion"], maxSelect: 1 },
      { name: "beneficio_esperado", type: "text" },
      { name: "responsable", type: "text" },
      { name: "prioridad", type: "select", values: ["alta", "media", "baja"], maxSelect: 1 },
      { name: "estado", type: "select", values: ["propuesta", "en_evaluacion", "aprobada", "en_implementacion", "implementada", "cerrada"], maxSelect: 1, required: true },
      { name: "fecha_implementacion", type: "date" },
  ...
  const recursos = new Collection({
    ...
    type: "base",
    fields: [
      { name: "tipo_recurso", type: "select", values: ["humano", "infraestructura", "tecnologico", "financiero", "informacion"], maxSelect: 1, required: true },
      { name: "nombre_recurso", type: "text", required: true },
      { name: "area", type: "text" },
      { name: "estado_actual", type: "select", values: ["disponible", "insuficiente", "adecuado", "requiere_mejora"], maxSelect: 1 },
      ...
      { name: "estado_solicitud", type: "select", values: ["pendiente", "aprobado", "rechazado", "en_proceso"], maxSelect: 1 },
      { name: "observaciones", type: "text" },
    ],
  })
  app.save(recursos)
  ...
  const auditorias_proveedores = new Collection({
    ...
    type: "base",
    fields: [
      { name: "proveedor_id", type: "relation", collectionId: proveedores.id, maxSelect: 1, cascadeDelete: false },
      { name: "fecha_auditoria", type: "date", required: true },
      { name: "tipo_auditoria", type: "select", values: ["inicial", "seguimiento", "recertificacion"], maxSelect: 1 },
      { name: "auditor", type: "text" },
      { name: "resultado", type: "select", values: ["aprobado", "condicional", "rechazado"], maxSelect: 1 },
      { name: "hallazgos", type: "text" },

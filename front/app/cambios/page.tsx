      ...
      <div className="flex justify-between items-center mb-8">
        <div>
          <div className="flex items-center gap-2 mb-1">
            ...
            <h1 className="text-xl font-bold text-slate-900 tracking-tight">Gestión de Cambios</h1>
          </div>
          <p className="text-sm text-slate-500 mt-1 ml-7">Planificación y control de cambios (6.3)</p>
        </div>
        <button
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
        <div className="card p-4 border border-slate-200/80">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-xs font-medium text-slate-500">Total Cambios</p>
              <p className="text-2xl font-bold text-slate-900">{cambios.length}</p>
            </div>
        ...
        <div className="card p-4 border border-slate-200/80">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-xs font-medium text-slate-500">Alta Prioridad</p>
              <p className="text-2xl font-bold text-slate-900">

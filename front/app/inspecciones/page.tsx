      ...
      <div className="flex justify-between items-center mb-8">
        <div>
          <div className="flex items-center gap-2 mb-1">
            ...
            <h1 className="text-xl font-bold text-slate-900 tracking-tight">Inspecciones y Verificación</h1>
          </div>
          <p className="text-sm text-slate-500 mt-1 ml-7">Control de calidad y verificación (8.6)</p>
        </div>
        <button
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <div className="card p-4 border border-slate-200/80">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-xs font-medium text-slate-500">Total Inspecciones</p>
              <p className="text-2xl font-bold text-slate-900">{inspecciones.length}</p>
            </div>
        ...
        <div className="card p-4 border border-slate-200/80">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-xs font-medium text-slate-500">Conformes</p>
        ...
        <div className="card p-4 border border-slate-200/80">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-xs font-medium text-slate-500">No Conformes</p>
              <p className="text-2xl font-bold text-slate-900">
            ...
            <table className="w-full">
              <thead className="bg-slate-50/80 border-b border-slate-200">
                <tr>
                  ...
                  <th className="px-6 py-3 text-left text-xs font-medium text-slate-500 uppercase tracking-wider">Conformidad</th>
